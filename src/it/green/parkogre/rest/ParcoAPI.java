...
public class ParcoAPI extends RestClient {
	private static final String GET_START_PARKS = "http://lazooo.redirectme.net/park/search/gps/";
	private static final String GET_PARKS = "http://lazooo.redirectme.net/park/search/query/";
